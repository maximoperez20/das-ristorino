...
/* ==========================================================
   RISTORINO - CREACIÓN DE TABLAS (formato JKMate previo)
...
CREATE TABLE dbo.sucursales_restaurantes (
  ...
  cod_sucursal_restaurante VARCHAR(40) NULL,       -- código legible opcional
...
CREATE TABLE dbo.dominio_categorias_preferencias (
  ...
  nom_valor_dominio VARCHAR(120) NOT NULL,
...
CREATE TABLE dbo.idiomas_categorias_preferencias (
  ...
  desc_categoria VARCHAR(400) NULL,
...
CREATE TABLE dbo.idiomas_dominio_cat_preferencias (
  ...
  nro_valor_dominio INT           NOT NULL,
  nro_idioma        VARCHAR(36)   NOT NULL,
  valor_dominio     VARCHAR(120) NOT NULL,
  desc_valor_dominio VARCHAR(400) NULL,
